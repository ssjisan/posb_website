    ...
    return (
        <Box sx={FooterContainerSx}>
            <Container sx={{ pt: "80px", pb: "32px", borderTop: "1px solid  rgba(145,158,171,0.32)" }}>
                ...
                <Box sx={BottomSx}>
                    <Typography variant="body1" color="text.secondary">POSB © {currentYear}</Typography>
                    <Typography variant="body1" color="text.secondary">Powered By Insighttech Bangladesh</Typography>
                </Box>
            </Container>
        </Box>
    )
